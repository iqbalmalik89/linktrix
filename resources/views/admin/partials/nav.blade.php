...
<!--               <input type="text" placeholder=" Search" class="form-control page-search"> -->
            ...
            <li class="profile-info dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <img class="img-circle profile_picture" alt="" width="70" height="70" src="{{$user['url']}}"><span class="user_name_span">{{$user['name']}}</span></a>
              <ul class="dropdown-menu">
                <li class="caret"></li>
                <li> <a href="edit-profile"> <i class="fa fa-user"></i> Edit Profile </a> </li>
                <li> <a href="logout"> <i class="fa fa-clipboard"></i> Log Out </a> </li>
              </ul>
            </li>
